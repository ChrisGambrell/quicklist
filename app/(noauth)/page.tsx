				...
				<div className='flex flex-col justify-center space-y-6'>
					<div className='space-y-4'>
						...
						<p className='max-w-[600px] text-gray-500 md:text-lg lg:text-xl dark:text-gray-400'>
							Elevate your online listings effortlessly. QuickList uses AI to automatically craft compelling titles, detailed
							descriptions, and smart pricing from your photos—quickly and effectively getting your items noticed.
						</p>
					</div>
