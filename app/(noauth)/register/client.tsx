...
export function ClientPage() {
	...
	return (
		<form action={action} className='grid gap-y-4 gap-x-2 grid-cols-2'>
			<FormInput label='First name' name='firstName' placeholder='First name' error={state?.errors.firstName} />
			<FormInput label='Last name' name='lastName' placeholder='Last name' error={state?.errors.lastName} />
			<FormInput
